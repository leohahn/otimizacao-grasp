...
##matrices containg information about which variables each
##clause contains. cla contains the indicators of presence
##of non negated variables and claN of negated variables
param cla {j in C, i in V} binary;
param claN {j in C, i in V} binary;

##vectors containing assigned values for each variables
##one vector (x) contains the value of each variables
##the other (xN) conatins the negated value of each variable
var x{i in V} binary;
